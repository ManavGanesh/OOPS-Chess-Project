...
public class InGameBottomMenu extends javax.swing.JPanel {
    ...
    private javax.swing.JComboBox<String> timerOptionsCombo;
    private javax.swing.JButton startTimerBTN;
    private javax.swing.JButton pauseTimerBTN;
    ...
    private void updateHintDisplay() {
        hintCounterLBL.setText("Hints: " + hintsRemaining + "/3");
        hintBTN.setEnabled(hintsRemaining > 0);
        
        if (hintsRemaining == 0) {
            hintBTN.setBackground(Color.GRAY);
            hintBTN.setForeground(Color.DARK_GRAY);
        } else {
    ...
    private void initComponents(boolean isAIMode) {
        ...
        hintCounterLBL.setText("Hints: 3/3");
    ...
    private void initTimerComponents() {
        ...
        timerOptionsCombo = new javax.swing.JComboBox<>();
        startTimerBTN = new javax.swing.JButton();
        pauseTimerBTN = new javax.swing.JButton();
        
        // Timer options
        timerOptionsCombo.addItem("1 minute");
        timerOptionsCombo.addItem("3 minutes");
        timerOptionsCombo.addItem("5 minutes");
        timerOptionsCombo.addItem("10 minutes");
        timerOptionsCombo.addItem("15 minutes");
        timerOptionsCombo.addItem("30 minutes");
        timerOptionsCombo.setSelectedItem("10 minutes"); // Default to 10 minutes
        ...
        startTimerBTN.setBackground(new Color(40, 167, 69)); // Green
        startTimerBTN.setForeground(Color.WHITE);
        startTimerBTN.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 10));
        startTimerBTN.setPreferredSize(new Dimension(60, 25));
        
        pauseTimerBTN.setText("Pause");
        pauseTimerBTN.setBackground(new Color(255, 193, 7)); // Yellow
        pauseTimerBTN.setForeground(Color.BLACK);
        pauseTimerBTN.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 10));
        pauseTimerBTN.setPreferredSize(new Dimension(60, 25));
        pauseTimerBTN.setEnabled(false);
        
        // Timer panel layout
        javax.swing.GroupLayout timerLayout = new javax.swing.GroupLayout(timerPanel);
        timerPanel.setLayout(timerLayout);
        timerPanel.setBackground(new Color(223, 238, 222));
        timerPanel.setBorder(BorderFactory.createTitledBorder("Game Timer"));
        
        timerLayout.setHorizontalGroup(
            timerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                .addComponent(timerOptionsCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGroup(timerLayout.createSequentialGroup()
                    .addComponent(blackTimerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(10)
                    .addComponent(whiteTimerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(timerLayout.createSequentialGroup()
                    .addComponent(startTimerBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(10)
                    .addComponent(pauseTimerBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        
        timerLayout.setVerticalGroup(
            timerLayout.createSequentialGroup()
                .addComponent(timerOptionsCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(5)
                .addGroup(timerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(blackTimerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(whiteTimerLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5)
                .addGroup(timerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(startTimerBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(pauseTimerBTN, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        
        // Add action listeners
        startTimerBTN.addActionListener(e -> startTimers());
        pauseTimerBTN.addActionListener(e -> pauseTimers());
        timerOptionsCombo.addActionListener(e -> resetTimers());
    ...
    /**
     * Reset timers based on selected time
     */
    private void resetTimers() {
        String selectedTime = (String) timerOptionsCombo.getSelectedItem();
    ...
    /**
     * Get timer panel for layout integration
     */
    public javax.swing.JPanel getTimerPanel() {
        return timerPanel;
    }
    ...
    /**
     * Initialize components for AI mode (without chat)
     */
    @SuppressWarnings("unchecked")
    private void initComponentsAI() {
        this.setBackground(new Color(223, 238, 222)); // Light green background
        ...
        // Right player name (AI)
        rightNamePanel = new JPanel(new GridBagLayout());
        rightNamePanel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 3));
        opponentNameLBL.setText("AI (Black)");
        opponentNameLBL.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
        rightNamePanel.add(opponentNameLBL);
        rightNamePanel.setPreferredSize(new Dimension(150, 30));
        ...
        // Black captured pieces panel - White background with black text
        jLabel2.setText("Black Captured");
        jLabel2.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
        jLabel2.setOpaque(true);
        jLabel2.setBackground(Color.WHITE);
        ...
        // White captured pieces panel - Black background with white text
        whiteCapturedLBL = new JLabel("White Captured");
        whiteCapturedLBL.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 14));
        whiteCapturedLBL.setOpaque(true);
        whiteCapturedLBL.setBackground(Color.BLACK);
